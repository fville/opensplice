...
LN               = ln
	# Archiving
AR               = powerpc-604-linux-gnu-ar
AR_CMDS          = rv
	# preprocessor
MAKEDEPFLAGS     = -M
CPP		 = powerpc-604-linux-gnu-cpp
GCPP		 = powerpc-604-linux-gnu-g++ -E
	# gcov
GCOV		 = powerpc-604-linux-gnu-gcov
...
LDLIBS_ODBC= -lodbc
LDLIBS_ZLIB = -lz
LDFLAGS_ZLIB = -L"$(UEIPACROOT)/lib"
CINCS_ZLIB = -I"$(UEIPACROOT)/include"
